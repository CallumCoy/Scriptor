...
|02 | ~~As a priest, I want to be able to search through the sermons.~~| 1 | HIGH | Iplement a list of the available songs to the left of the portals screen | COMPLETED | Callum |
...
|11| ~~As a churchgoer, I want to be able to access the options menu to edit the appearance of the application (font size, color)~~.| 1 | 4 | There is a menu button on both the front page of the IOS and Android app | COMPLETED | Wanda |
