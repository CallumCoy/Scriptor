...
|006|As a priest, I want to be able to set up a profile for my church so we I can set up the songs independently of other churches.|3|MEDIUM|Ability to register a church and have a unique database for each church exists.|UNSTARTED|  |
...
|009|As a priest, I want to be able to set up a account for my church account.|6|HIGH|Ability to search registered churches by name exists.|UNSTARTED|  |
|010|~~As a priest, I want to be able to sign into my church on the portal.|5|HIGH|Things won't be left out of date.~~|COMPLETED| Adrian |
...
|017|~~As a churchgoer, I want to be able to access songs and sermons from previous and upcoming days.|4|MEDUIM|We will have a menu were you can select what day you want to view the sermons from.~~|COMPLETED|Callum|
...
|021|As an priest, I want to be able to see the length of the song in the database.|1|0|LOW|Each song is accompanied by the word count.|UNSTARTED|  |
...
|023|As a priest I want to be able choose from a list of songs to sing during the ceremony.|2|MEDUIM|There will be a SQL database with a selection of songs|UNSTARTED|  |
|024|As a priest I want to be able to add songs to my playlist|3|HIGH|There will be a list of the songs to add to the playlist.|UNSTARTED|  |
